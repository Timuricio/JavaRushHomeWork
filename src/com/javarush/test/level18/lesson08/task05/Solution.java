...
public class Solution {
    public class TableInterfaceWrapper implements ATableInterface{
        private ATableInterface interf;
        public TableInterfaceWrapper(ATableInterface interf)
        {
            this.interf = interf;
        }
        ...
        public void setModel(List rows)
        {
            ...
            interf.setModel(rows);
        }

        @Override
        public String getHeaderText()
        {
            return interf.getHeaderText().toUpperCase();
        }

        @Override
        public void setHeaderText(String newHeaderText)
        {
            interf.setHeaderText(newHeaderText);
        }
    }
