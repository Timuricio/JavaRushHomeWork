...
public class Solution
{
    ...
    public static Item getProxy(Class classReturn, Class... interfaces)
    {
        ClassLoader loader = classReturn.getClass().getClassLoader();
        Class<?>[] interf = interfaces;
        ItemInvocationHandler handler = new ItemInvocationHandler();
        return (Item)Proxy.newProxyInstance(loader,interf,handler);
    }
}
