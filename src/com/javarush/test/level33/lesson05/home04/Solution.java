...
public class Solution
{
    ...
    public static Object convertOneToAnother(Object one, Class resultClassObject) throws IOException
    {
        ...
        String inputClassName = one.getClass().getSimpleName().toLowerCase();
        String outputClassName = resultClassObject.getSimpleName().toLowerCase();
        String serializ = stringWriter.toString();
        String resultSerializ = serializ.replaceFirst(inputClassName,outputClassName);

        StringReader stringReader = new StringReader(resultSerializ);
        Object object = mapper.readValue(stringReader,resultClassObject);
        return object;
    }
